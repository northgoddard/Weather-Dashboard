...
function getCoords(event){
    ...
    var geoCodeURL = `https://api.openweathermap.org/geo/1.0/direct?q=${searchTerm},US&limit=1&appid=43d36ca9362f387db0e18b387f02181e`
    if(!searchTerm){
...
function getCurrentWeather(lon, lat){
    var weatherURL = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&units=imperial&appid=43d36ca9362f387db0e18b387f02181e`;
    if(!lon || !lat){
        console.log("bad input")
        return;
    }
...
function getForceast(){
    var url = `https://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&units=imperial&appid=43d36ca9362f387db0e18b387f02181e`;
    if(!lon || !lat){
        console.log("bad input")
        return;
    }
